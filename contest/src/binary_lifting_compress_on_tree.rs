...
use crate::{algebraic_structure::Monoid, util::{should_eq, debug}, arithmetic::{IdentityAdd, Nil}};
...
/// 
/// ```
/// use contest::root_tree::*;
/// use contest::{algebraic_structure::Monoid, arithmetic::{IdentityAdd, Nil}};
/// use contest::binary_lifting_compress_on_tree::*;
